...
%                                                                                                                                                             %
% general_algebra_review.tex   linear_algebra_review.tex                                                                                                      %
%                                                                                                                                                             %
...
\begin{lemma} 
    ...
    \begin{enumerate}
        \item Soit \( G, G^*, M \in \Q^{n \x n}\) et \( H, H^*, N  \in \Q^{n \x n} \) les matrices des \( \bg_k \), \( g^*_k \), \( \mu_{k,l} \) avant et après \hyperref[step:PP]{\emph{Proprification partielle de $\bg_i$}}. Soit \( E = I_n -\lceil \mu_{i,j} \rfloor E_{i,j} \in \Z^{n \x n} \), où \( E_{i,j}\) désigne la matrice élémentaire.
        ...
        \item Avant \hyperref[step:PP]{\emph{Proprification partielle de $\bg_i$}}, on a :
        \[
...
\begin{proof}
    \begin{enumerate}
        \item \begin{itemize}[label=\textbullet]
            \item \hyperref[step:PP]{\emph{Proprification partielle de $\bg_i$}} se traduit matriciellement par \( H = EG \).
...
\begin{proof}
    \begin{enumerate}
        \item Il faut utiliser le théorème~\ref{thm:complexite-GSO}
        
        \item Une exécution de \hyperref[step:PP]{\emph{Proprification partielle de \( \bg_i \)}} revient à faire les multiplications \( H=EG \) et \( N=EM \) se font en \( \OO(n) \) étapes, ainsi une exécution de \hyperref[step:P]{\emph{Proprification de \( \bg_i \)}} nécessite \( \OO(n^2) \) opérations dans \( \Z \).
...
\begin{lemma}
    ...
    \begin{enumerate}
        ...
        \item À chaque exécution de l’étape \hyperref[step:PP]{\emph{Proprification partielle de \( \bg_i \)}}, on a :
        \[
        \|\bg_i\| \leq n(2A)^n.
        \]
    \end{enumerate}
...
\begin{proof}
    \begin{enumerate}
        ...
        Considérons maintenant le remplacement effectué à l'étape  \hyperref[step:PP]{\emph{Proprification partielle de \( \bg_i \)}}. Comme \( m_i \geq 1 \) et que \( |\mu_{j,l}| \leq \tfrac{1}{2} \) pour \( 1 \leq l < j \), le lemme 2.8 donne :
        \[
        \begin{aligned}
...
%                                                                                                                                                             %
\input{general_algebra_review}                                      % Annexe A : Rappels d’algèbre générale (anneaux, modules)                                %
%                                                                                                                                                             %
\input{linear_algebra_review}                                       % Annexe B : Rappels d’algèbre linéaire (Gram-Schmidt, matrices, normes, matrice de Gram) %
%                                                                                                                                                             %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%