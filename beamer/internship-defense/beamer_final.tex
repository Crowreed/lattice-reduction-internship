...
\author{Lucas Petit \texorpdfstring{\\}{ - } \textbf{Encadrant}: Romain Lebreton}
\date{3 juillet 2025}
...
\begin{frame}{Une étape de diviser-pour-régner}
    ...
    \begin{textblock*}{\paperwidth}(0.5cm,5.5cm)
        ...
        \uncover<5->
        {
            ...
            \textbf{Piste 1} : ShiftLLL($B$, $S^*$) qui calcule \( B \) tel que \( B S^* \) est LLL-réduite
            \begin{itemize}
                \item \textbf{Théorème} : ShiftLLL est correct
